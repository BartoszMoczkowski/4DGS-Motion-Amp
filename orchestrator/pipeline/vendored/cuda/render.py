...
#
"""Vendored, verbatim copy of the repo-root ``render.py`` (T09 copy-in, per
...
a separate process inside the ``cuda`` container (``pipeline/stages/render.py`` builds the CLI
