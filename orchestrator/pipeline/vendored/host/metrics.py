"""Vendored, verbatim copy of ``motion_seg/metrics.py`` (2026-07-14 copy-in rework of T07; see
``pipeline.vendored``'s module docstring). Only the module path changed — every function body
below is byte-for-byte the reference script's.
